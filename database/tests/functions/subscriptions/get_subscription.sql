...
select is(
    ...
    'Suscription for user1 and package1 should be returned'
);
select is(
    get_subscription('
    {
    ...
    'Suscription for user1 and package2 should be returned'
);
select is_empty(
    $$
    ...
    $$,
    'No subscription should be returned for user2 and package1'
);
